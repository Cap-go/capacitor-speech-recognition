...
| **`muteRecognizerBeep`**     | <code>boolean</code>  | Suppresses the Android system beep when inline recognition starts or restarts. Defaults to `true` when `continuousPTT` is enabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| **`mute`** | <code>boolean</code> | When set, updates whether Android should suppress the recognizer start beep for the active session. |
